...
BU = Project(name='rm the Numbers:  Supporting Female Engineers at Chadwick', session_number=1)
...
none = Project(name='Take a Risk: An Antidote to an Overly Serious Youth: Bryce Baldridge', session_number=2)
session.add(none)
session.add(A)
session.add(B)
session.add(C)
